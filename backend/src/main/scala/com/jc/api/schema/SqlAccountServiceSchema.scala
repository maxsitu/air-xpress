...
trait SqlAccountServiceSchema {
  ...
  implicit def GetResultConsumerBidsRow(implicit e0: GR[Long], e1: GR[java.util.UUID], e2: GR[Option[Boolean]], e3: GR[OffsetDateTime], e4: GR[Int]): GR[ConsumerBid] = GR{
    prs => import prs._
      ConsumerBid.tupled((<<[Long], <<[Long], <<[java.util.UUID], <<[Int], <<?[Boolean], <<[Boolean], <<[Boolean], <<[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ConsumerBids(_tableTag: Tag) extends profile.api.Table[ConsumerBid](_tableTag, "CONSUMER_BIDS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(providerAskId), Rep.Some(bidderId), Rep.Some(passengers), active, confirmed, charged, refunded, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ConsumerBid.tupled((_1.get, _2.get, _3.get, _4.get, _5, _6, _7, _8,  _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultProviderBidsRow(implicit e0: GR[Long], e1: GR[java.util.UUID], e2: GR[Option[Boolean]], e3: GR[OffsetDateTime]): GR[ProviderBid] = GR{
    prs => import prs._
      ProviderBid.tupled((<<[Long], <<[Long], <<[java.util.UUID], <<[Double], <<?[Boolean], <<[Boolean], <<[Boolean], <<[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ProviderBids(_tableTag: Tag) extends profile.api.Table[ProviderBid](_tableTag, "PROVIDER_BIDS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(consumerAskId), Rep.Some(bidderId), price, active, confirmed, charged, refunded, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ProviderBid.tupled((_1.get, _2.get, _3.get, _4, _5, _6, _7, _8, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
