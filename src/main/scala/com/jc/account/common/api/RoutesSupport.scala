package com.jc.account.common.api
...
import akka.http.scaladsl.server.Directives.{complete, pathSuffixTest, respondWithHeaders}
import akka.http.scaladsl.unmarshalling.{FromEntityUnmarshaller, Unmarshaller}
import akka.stream.Materializer
import com.jc.account.common.api.`X-Content-Type-Options`.`nosniff`
import com.jc.account.common.api.`X-Frame-Options`.`DENY`
import com.jc.account.common.api.`X-XSS-Protection`.`1; mode=block`
import io.circe.{Decoder, Encoder}
import io.circe.jawn.decode

/**
  * Created by walle on 4/29/17.
  */
