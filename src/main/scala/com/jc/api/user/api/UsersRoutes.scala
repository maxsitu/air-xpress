...
import com.jc.api.user.application.UserRegisterResult.{InvalidData, UserExists}
import com.jc.api.user.application.{Session, UserRegisterResult, UserService}
import com.jc.api.user.domain.BasicUserData
