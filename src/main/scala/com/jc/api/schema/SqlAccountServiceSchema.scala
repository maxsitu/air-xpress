...
import com.jc.api.model.{BasicUserData, Pilot}
...
trait SqlAccountServiceSchema {
  ...
  lazy val schema: database.profile.SchemaDescription = Array(consumeOrders.schema, consumerAsks.schema, consumerBids.schema, flightPlans.schema, flightSteps.schema, locations.schema, passwordResetCodes.schema, pilots.schema, planeProviderMappings.schema, planeProviders.schema, planes.schema, provideOrders.schema, providerAsks.schema, providerBids.schema, rememberMeTokens.schema, userRoleMappings.schema, userRoles.schema, users.schema).reduceLeft(_ ++ _)
  ...
  case class ConsumeOrdersRow(consumerAskId: Long, providerBidId: Long, confirmed: Option[Boolean] = Some(false), createdOn: OffsetDateTime, modifiedOn: OffsetDateTime)
  /** GetResult implicit for fetching ConsumeOrdersRow objects using plain SQL queries */
  implicit def GetResultConsumeOrdersRow(implicit e0: GR[Long], e1: GR[Option[Boolean]], e2: GR[OffsetDateTime]): GR[ConsumeOrdersRow] = GR{
    prs => import prs._
      ConsumeOrdersRow.tupled((<<[Long], <<[Long], <<?[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ConsumeOrders(_tableTag: Tag) extends profile.api.Table[ConsumeOrdersRow](_tableTag, "CONSUME_ORDERS") {
    ...
    def ? = (Rep.Some(consumerAskId), Rep.Some(providerBidId), confirmed, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ConsumeOrdersRow.tupled((_1.get, _2.get, _3, _4.get, _5.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val consumerAsksFk = foreignKey("CONSUME_ORDERS_consumer_ask_id_fkey", consumerAskId, consumerAsks)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing ProviderBids (database name CONSUME_ORDERS_provider_bid_id_fkey) */
    lazy val providerBidsFk = foreignKey("CONSUME_ORDERS_provider_bid_id_fkey", providerBidId, providerBids)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table ConsumeOrders */
  lazy val consumeOrders = new TableQuery(tag => new ConsumeOrders(tag))

  import com.jc.api.model.ConsumerAsk

  /** GetResult implicit for fetching ConsumerAsksRow objects using plain SQL queries */
  implicit def GetResultConsumerAsksRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[java.util.UUID], e3: GR[Int], e4: GR[Option[Boolean]], e5: GR[OffsetDateTime]): GR[ConsumerAsk] = GR{
    prs => import prs._
      ConsumerAsk.tupled((<<[Long], <<?[Long], <<[java.util.UUID], <<[Int], <<?[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ConsumerAsks(_tableTag: Tag) extends profile.api.Table[ConsumerAsk](_tableTag, "CONSUMER_ASKS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), planId, Rep.Some(consumerId), Rep.Some(passengers), active, Rep.Some(askedOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ConsumerAsk.tupled((_1.get, _2, _3.get, _4.get, _5, _6.get, _7.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val flightPlansFk = foreignKey("CONSUMER_ASKS_plan_id_fkey", planId, flightPlans)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Users (database name CONSUMER_ASKS_consumer_id_fkey) */
    lazy val usersFk = foreignKey("CONSUMER_ASKS_consumer_id_fkey", consumerId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  implicit def GetResultConsumerBidsRow(implicit e0: GR[Long], e1: GR[java.util.UUID], e2: GR[Option[Boolean]], e3: GR[OffsetDateTime], e4: GR[Int]): GR[ConsumerBid] = GR{
    prs => import prs._
      ConsumerBid.tupled((<<[Long], <<[Long], <<[java.util.UUID], <<[Int], <<?[Boolean], <<?[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ConsumerBids(_tableTag: Tag) extends profile.api.Table[ConsumerBid](_tableTag, "CONSUMER_BIDS") {
    def * = (id, providerAskId, bidderId, passengers, active, confirmed, createdOn, modifiedOn) <> (ConsumerBid.tupled, ConsumerBid.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(providerAskId), Rep.Some(bidderId), Rep.Some(passengers), active, confirmed, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ConsumerBid.tupled((_1.get, _2.get, _3.get, _4.get, _5, _6, _7.get, _8.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val providerAsksFk = foreignKey("CONSUMER_BIDS_provider_ask_id_fkey", providerAskId, providerAsks)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Users (database name CONSUMER_BIDS_bidder_id_fkey) */
    lazy val usersFk = foreignKey("CONSUMER_BIDS_bidder_id_fkey", bidderId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  /** Entity class storing rows of table FlightPlans
    ...
    *  @param createdOn Database column created_on SqlType(OffsetDateTime)
    *  @param modifiedOn Database column modified_on SqlType(OffsetDateTime) */
  case class FlightPlansRow(id: Long, ownerId: Option[java.util.UUID] = None, description: Option[String] = None, startTime: Option[OffsetDateTime] = None, endTime: Option[OffsetDateTime] = None, createdOn: OffsetDateTime, modifiedOn: OffsetDateTime)
  /** GetResult implicit for fetching FlightPlansRow objects using plain SQL queries */
  implicit def GetResultFlightPlansRow(implicit e0: GR[Long], e1: GR[Option[java.util.UUID]], e2: GR[Option[String]], e3: GR[Option[OffsetDateTime]], e4: GR[OffsetDateTime]): GR[FlightPlansRow] = GR{
    prs => import prs._
      FlightPlansRow.tupled((<<[Long], <<?[java.util.UUID], <<?[String], <<?[OffsetDateTime], <<?[OffsetDateTime], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class FlightPlans(_tableTag: Tag) extends profile.api.Table[FlightPlansRow](_tableTag, "FLIGHT_PLANS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), ownerId, description, startTime, endTime, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> FlightPlansRow.tupled((_1.get, _2, _3, _4, _5, _6.get, _7.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val usersFk = foreignKey("FLIGHT_PLANS_owner_id_fkey", ownerId, users)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  case class FlightStepsRow(id: Long, planId: Long, fromLocationId: Int, toLocationId: Int, fromTime: OffsetDateTime, toTime: OffsetDateTime)
  /** GetResult implicit for fetching FlightStepsRow objects using plain SQL queries */
  implicit def GetResultFlightStepsRow(implicit e0: GR[Long], e1: GR[Int], e2: GR[OffsetDateTime]): GR[FlightStepsRow] = GR{
    prs => import prs._
  ...
  class FlightSteps(_tableTag: Tag) extends profile.api.Table[FlightStepsRow](_tableTag, "FLIGHT_STEPS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(planId), Rep.Some(fromLocationId), Rep.Some(toLocationId), Rep.Some(fromTime), Rep.Some(toTime)).shaped.<>({r=>import r._; _1.map(_=> FlightStepsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val flightPlansFk = foreignKey("FLIGHT_STEPS_plan_id_fkey", planId, flightPlans)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
    /** Foreign key referencing Locations (database name FLIGHT_STEPS_from_location_id_fkey) */
    lazy val locationsFk2 = foreignKey("FLIGHT_STEPS_from_location_id_fkey", fromLocationId, locations)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
    /** Foreign key referencing Locations (database name FLIGHT_STEPS_to_location_id_fkey) */
    lazy val locationsFk3 = foreignKey("FLIGHT_STEPS_to_location_id_fkey", toLocationId, locations)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
  }
  ...
  case class LocationsRow(id: Int, code: String, name: String, geoLat: Double, geoLon: Double)
  /** GetResult implicit for fetching LocationsRow objects using plain SQL queries */
  implicit def GetResultLocationsRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Double]): GR[LocationsRow] = GR{
    prs => import prs._
  ...
  class Locations(_tableTag: Tag) extends profile.api.Table[LocationsRow](_tableTag, "LOCATIONS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(code), Rep.Some(name), Rep.Some(geoLat), Rep.Some(geoLon)).shaped.<>({r=>import r._; _1.map(_=> LocationsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  case class PasswordResetCodesRow(id: java.util.UUID, code: String, userId: java.util.UUID, validTo: OffsetDateTime)
  /** GetResult implicit for fetching PasswordResetCodesRow objects using plain SQL queries */
  implicit def GetResultPasswordResetCodesRow(implicit e0: GR[java.util.UUID], e1: GR[String], e2: GR[OffsetDateTime]): GR[PasswordResetCodesRow] = GR{
    prs => import prs._
  ...
  class PasswordResetCodes(_tableTag: Tag) extends profile.api.Table[PasswordResetCodesRow](_tableTag, "PASSWORD_RESET_CODES") {
    def * = (id, code, userId, validTo) <> (PasswordResetCodesRow.tupled, PasswordResetCodesRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(code), Rep.Some(userId), Rep.Some(validTo)).shaped.<>({r=>import r._; _1.map(_=> PasswordResetCodesRow.tupled((_1.get, _2.get, _3.get, _4.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val usersFk = foreignKey("PASSWORD_RESET_CODES_user_id_fkey", userId, users)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
  }
  ...
  implicit def GetResultPilotsRow(implicit e0: GR[Int], e1: GR[java.util.UUID], e2: GR[String]): GR[Pilot] = GR{
    prs => import prs._
  ...
  class Pilots(_tableTag: Tag) extends profile.api.Table[Pilot](_tableTag, "PILOTS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(userId), Rep.Some(licenseNum)).shaped.<>({r=>import r._; _1.map(_=> Pilot.tupled((_1.get, _2.get, _3.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val usersFk = foreignKey("PILOTS_user_id_fkey", userId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  class PlaneProviderMappings(_tableTag: Tag) extends profile.api.Table[PlaneProviderMappingsRow](_tableTag, "PLANE_PROVIDER_MAPPINGS") {
    def * = (providerId, planeId) <> (PlaneProviderMappingsRow.tupled, PlaneProviderMappingsRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(providerId), Rep.Some(planeId)).shaped.<>({r=>import r._; _1.map(_=> PlaneProviderMappingsRow.tupled((_1.get, _2.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val planesFk = foreignKey("PLANE_PROVIDER_MAPPINGS_plane_id_fkey", planeId, planes)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing PlaneProviders (database name PLANE_PROVIDER_MAPPINGS_provider_id_fkey) */
    lazy val planeProvidersFk = foreignKey("PLANE_PROVIDER_MAPPINGS_provider_id_fkey", providerId, planeProviders)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
  }
  ...
  case class PlaneProvidersRow(id: Int, userId: java.util.UUID, lincenceNum: String)
  /** GetResult implicit for fetching PlaneProvidersRow objects using plain SQL queries */
  implicit def GetResultPlaneProvidersRow(implicit e0: GR[Int], e1: GR[java.util.UUID], e2: GR[String]): GR[PlaneProvidersRow] = GR{
    prs => import prs._
  ...
  class PlaneProviders(_tableTag: Tag) extends profile.api.Table[PlaneProvidersRow](_tableTag, "PLANE_PROVIDERS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(userId), Rep.Some(lincenceNum)).shaped.<>({r=>import r._; _1.map(_=> PlaneProvidersRow.tupled((_1.get, _2.get, _3.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val usersFk = foreignKey("PLANE_PROVIDERS_user_id_fkey", userId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  implicit def GetResultPlanesRow(implicit e0: GR[Int], e1: GR[String], e2: GR[java.util.UUID]): GR[Plane] = GR{
    prs => import prs._
      Plane.tupled((<<[Int], <<[String], <<[String], <<[String], <<[String], <<[java.util.UUID], <<[Int], <<[Int], <<[Int]))
  }
  ...
  class Planes(_tableTag: Tag) extends profile.api.Table[Plane](_tableTag, "PLANES") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(nNo), Rep.Some(manufacturerName), Rep.Some(serialNo), Rep.Some(model), Rep.Some(ownerId), Rep.Some(pilotSeats), Rep.Some(minPilot), Rep.Some(customerSeats)).shaped.<>({r=>import r._; _1.map(_=> Plane.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val usersFk = foreignKey("PLANES_owner_id_fkey", ownerId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  /** Entity class storing rows of table ProvideOrders
    ...
    *  @param createdOn Database column created_on SqlType(OffsetDateTime)
    *  @param modifiedOn Database column modified_on SqlType(OffsetDateTime) */
  case class ProvideOrdersRow(providerAskId: Long, consumerBidId: Long, confirmed: Option[Boolean] = Some(false), createdOn: OffsetDateTime, modifiedOn: OffsetDateTime)
  /** GetResult implicit for fetching ProvideOrdersRow objects using plain SQL queries */
  implicit def GetResultProvideOrdersRow(implicit e0: GR[Long], e1: GR[Option[Boolean]], e2: GR[OffsetDateTime]): GR[ProvideOrdersRow] = GR{
    prs => import prs._
  ...
  class ProvideOrders(_tableTag: Tag) extends profile.api.Table[ProvideOrdersRow](_tableTag, "PROVIDE_ORDERS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(providerAskId), Rep.Some(consumerBidId), confirmed, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ProvideOrdersRow.tupled((_1.get, _2.get, _3, _4.get, _5.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val consumerBidsFk = foreignKey("PROVIDE_ORDERS_consumer_bid_id_fkey", consumerBidId, consumerBids)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing ProviderAsks (database name PROVIDE_ORDERS_provider_ask_id_fkey) */
    lazy val providerAsksFk = foreignKey("PROVIDE_ORDERS_provider_ask_id_fkey", providerAskId, providerAsks)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  implicit def GetResultProviderAsksRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[java.util.UUID], e3: GR[Int], e4: GR[Double], e5: GR[Option[Boolean]], e6: GR[OffsetDateTime]): GR[ProviderAsk] = GR{
    prs => import prs._
      ProviderAsk.tupled((<<[Long], <<?[Long], <<[java.util.UUID], <<[Int], <<[Double], <<?[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ProviderAsks(_tableTag: Tag) extends profile.api.Table[ProviderAsk](_tableTag, "PROVIDER_ASKS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), planId, Rep.Some(providerId), Rep.Some(seats), Rep.Some(price), active, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ProviderAsk.tupled((_1.get, _2, _3.get, _4.get, _5.get, _6, _7.get, _8.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val flightPlansFk = foreignKey("PROVIDER_ASKS_plan_id_fkey", planId, flightPlans)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Users (database name PROVIDER_ASKS_provider_id_fkey) */
    lazy val usersFk = foreignKey("PROVIDER_ASKS_provider_id_fkey", providerId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  implicit def GetResultProviderBidsRow(implicit e0: GR[Long], e1: GR[java.util.UUID], e2: GR[Option[Boolean]], e3: GR[OffsetDateTime]): GR[ProviderBid] = GR{
    prs => import prs._
      ProviderBid.tupled((<<[Long], <<[Long], <<[java.util.UUID], <<?[Boolean], <<?[Boolean], <<[OffsetDateTime], <<[OffsetDateTime]))
  }
  ...
  class ProviderBids(_tableTag: Tag) extends profile.api.Table[ProviderBid](_tableTag, "PROVIDER_BIDS") {
    def * = (id, consumerAskId, bidderId, active, confirmed, createdOn, modifiedOn) <> (ProviderBid.tupled, ProviderBid.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(consumerAskId), Rep.Some(bidderId), active, confirmed, Rep.Some(createdOn), Rep.Some(modifiedOn)).shaped.<>({r=>import r._; _1.map(_=> ProviderBid.tupled((_1.get, _2.get, _3.get, _4, _5, _6.get, _7.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val consumerAsksFk = foreignKey("PROVIDER_BIDS_consumer_ask_id_fkey", consumerAskId, consumerAsks)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Users (database name PROVIDER_BIDS_bidder_id_fkey) */
    lazy val usersFk = foreignKey("PROVIDER_BIDS_bidder_id_fkey", bidderId, users)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  class RememberMeTokens(_tableTag: Tag) extends profile.api.Table[RememberMeTokensRow](_tableTag, "REMEMBER_ME_TOKENS") {
    ...
    lazy val usersFk = foreignKey("REMEMBER_ME_TOKENS_user_id_fkey", userId, users)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
  }
  ...
  implicit def GetResultUserStatus(implicit e0: GR[Int], e1: GR[String]): GR[UserStatus] = GR{
    prs => import prs._
  ...
  class UserStatuses(_tableTag: Tag) extends profile.api.Table[UserStatus](_tableTag, "USER_STATUSES") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(status)).shaped.<>({r=>import r._; _1.map(_=> (UserStatus.apply _).tupled((_1.get, _2.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultUserRoles(implicit e0: GR[Int], e1: GR[String]): GR[UserRole] = GR{
    prs => import prs._
  ...
  class UserRoles(_tableTag: Tag) extends profile.api.Table[UserRole](_tableTag, "USER_ROLES") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(role)).shaped.<>({r=>import r._; _1.map(_=> (UserRole.apply _).tupled((_1.get, _2.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultUsersRow(implicit e0: GR[java.util.UUID], e1: GR[String], e2: GR[OffsetDateTime], e3: GR[Int]): GR[User] = GR{
    prs => import prs._
      (User.apply _).tupled((<<[java.util.UUID], <<[String], <<[String], <<[String], <<[String], <<[String], <<[Int], <<[OffsetDateTime]))
  }
  ...
  class Users(_tableTag: Tag) extends profile.api.Table[User](_tableTag, "USERS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(login), Rep.Some(loginLowercase), Rep.Some(email), Rep.Some(password), Rep.Some(salt), Rep.Some(userStatusId), Rep.Some(createdOn)).shaped.<>({r=>import r._; _1.map(_=> (User.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val userStatusFk = foreignKey("USERS_user_status_id_fkey", userStatusId, userStatuses)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  class UserRoleMappings(_tableTag: Tag) extends profile.api.Table[UserRoleMapping](_tableTag, "USER_ROLE_MAPPINGS") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(userId), Rep.Some(roleId)).shaped.<>({r=>import r._; _1.map(_=> UserRoleMapping.tupled((_1.get, _2.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val usersFk = foreignKey("USER_ROLE_MAPPINGS_user_id_fkey", userId, users)(r => r.id, onUpdate=ForeignKeyAction.Cascade, onDelete=ForeignKeyAction.Cascade)
    /** Foreign key referencing UserRoles (database name USER_ROLE_MAPPINGS_role_id_fkey) */
    lazy val userRolesFk = foreignKey("USER_ROLE_MAPPINGS_role_id_fkey", roleId, userRoles)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
